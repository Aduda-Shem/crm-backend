...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'DRF API for managing leads, contacts, notes, reminders, and correspondence.',
    'VERSION': '1.0.0',
}
...
CORS_ALLOWED_ORIGINS = os.getenv('DJANGO_CORS_ORIGIN_WHITELIST', 'http://localhost:5173').split(',')
